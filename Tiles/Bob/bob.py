...
class Bob: 
    ...
    def __init__(self):
        ...
        self.owner=self.setting.pseudo
...
################ Die and Born ############################
    def spawn_online(self, tile: 'Tile'):
    ...
    def spawn(self, tile: 'Tile'):
        ...
        self.CurrentTile.addBob(self)
        GameControl.getInstance().addToNewBornQueue(self) 
        send((Packet("SPAWN_B","DICT",setting.pseudo, (str(self.id) + ";" + str(self.CurrentTile.gridX) + ";" + str(self.CurrentTile.gridY)+ ";" ))).stringify(),setting.ecriture_fd)
    ...
    def die(self):
        ...
        GameControl.getInstance().addToDiedQueue(self)
        # self.alive = False
        send((Packet("DIE_B","DICT",setting.pseudo, (str(self.id) + ";" + str(self.CurrentTile.gridX) + ";" + str(self.CurrentTile.gridY)+ ";" ))).stringify(),setting.ecriture_fd)
